...
function PaymentMethods() {
    ...
    const columns = [
        {
            ...
            render: (_: any, record: any) => <>
                <a onClick={() => handleShowView(record)}>{record.PaymentMethodID}</a>
            </>,
        },
        {
            title: "Họ",
    ...
    const handleDelete = (item: any) => {
        const newData = data.filter((dataItem) => dataItem.PaymentMethodID !== item.PaymentMethodID);
        setData(newData);
    };
    ...
    return (
        <div className="main-body">
            ...
            >
                {selectedRow && (
                    <div>
                        <p>PaymentMethod: {selectedRow.PaymentMethodID}</p>
