...
function ShippingMethods() {
    ...
    const columns = [
        {
            ...
            render: (_: any, record: any) => <>
                <a onClick={() => handleShowView(record)}>{record.ShippingMethodID}</a>
            </>,
        },
        {
            title: "Họ",
    ...
    const handleDelete = (item: any) => {
        const newData = data.filter((dataItem) => dataItem.ShippingMethodID !== item.ShippingMethodID);
        setData(newData);
    };
    ...
    return (
        <div className="main-body">
            ...
            >
                {selectedRow && (
                    <div>
                        <p>ShippingMethod: {selectedRow.ShippingMethodID}</p>
