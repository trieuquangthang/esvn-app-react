...
function ShippingMethods() {
        ...
        [
            {
                ...
                stt: 1,
                shippingID: 1,
                shippingDate: 'Triệu Quang Đức',
                shippingAddress: '0941399432',
                CustomerID: 1,
                orderID: 1,
    ...
    const columns: ColumnsType<DataType> = [
...

        {
            ...
            render: (_, record) => <>
                <a onClick={() => showModal()}>{record.shippingID}</a>
            </>,
        },
        {
            title: 'shippingDate',
    ...
    return (
        <>
            ...
            <Modal title="Thêm mới" open={isModalOpen} onOk={handleOk} onCancel={handleCancel}>
                ...
                >
                    <Form.Item name={['user', 'ShippingID']} label="shippingID" rules={[{ required: true }]}>
                        <Input />
                    </Form.Item>
                    <Form.Item name={['user', 'ShippingDate']} label="shippingDate" >
                        <Input />
                    </Form.Item>
                    <Form.Item name={['user', 'ShippingAddress']} label="shippingAddress" >
                        <InputNumber />
                    </Form.Item>
                    <Form.Item name={['user', 'CustomerID']} label="CustomerID" >
                        <Input />
                    </Form.Item>
                    <Form.Item name={['user', 'orderID']} label="OrderID">
                        <Input />
                    </Form.Item>
