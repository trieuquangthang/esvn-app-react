...
function Shippings() {
    ...
    const columns = [
        {
            ...
            render: (_: any, record: any) => <>
                <a onClick={() => handleShowView(record)}>{record.ShippingID}</a>
            </>,
        },
        {
            title: "Họ",
    ...
    const handleDelete = (item: any) => {
        const newData = data.filter((dataItem) => dataItem.ShippingID !== item.ShippingID);
        setData(newData);
    };
    ...
    return (
        <div className="main-body">
            ...
            >
                {selectedRow && (
                    <div>
                        <p>Shipping: {selectedRow.ShippingID}</p>
