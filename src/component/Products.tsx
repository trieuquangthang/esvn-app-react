...
function Products() {
    ...
    const columns = [
        {
            ...
            render: (_: any, record: any) => <>
                <a onClick={() => handleShowView(record)}>{record.ProductID}</a>
            </>,
        },
        {
            title: "Họ",
    ...
    const handleDelete = (item: any) => {
        const newData = data.filter((dataItem) => dataItem.ProductID !== item.ProductID);
        setData(newData);
    };
    ...
    return (
        <div className="main-body">
            ...
            >
                {selectedRow && (
                    <div>
                        <p>Product: {selectedRow.ProductID}</p>
